...
<html lang="en">
    ...
    <body class="app sidebar-mini rtl">
        ...
        <main class="app-content">
            <luannm:set var="robot" value="${sessionScope.robot3}"/>
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <luannm:choose>
                            <luannm:when test="${sessionScope.weaponlist3 == null}">
                                <h4>The robot have no weapon</h4> 
                            </luannm:when>
                            <luannm:when test="${sessionScope.weaponlist3.size() == 0}">
                                <h4>The robot have no weapon</h4> 

                            </luannm:when>
                            <luannm:otherwise>
                                <luannm:set var="list" value="${sessionScope.weaponlist3}" /> 
                                ...
                                <div class="tile-footer" hidden>
                            <div class="row">
                                <div class="col-md-8 col-md-offset-3">
                                    <a class="btn btn-primary" href="FrontController?action=ToEditRobot">Edit Robot</a>
                                </div>
                            </div>
                        </div>
