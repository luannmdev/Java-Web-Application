                        ...
                        <div class="tile-body">
                            ...
                            <form class="form-horizontal" action="FrontController" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input name="mission_name" class="form-control col-md-8" type="text" placeholder="${missionDetail.mission_name}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3">Description</label>
                                    <div class="col-md-8">
                                        <input name="description" class="form-control col-md-8" type="text" placeholder="${missionDetail.description}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3">Date Start</label>
                                    <div class="col-md-8">
                                        <input name="date_start" class="form-control col-md-8" type="text" placeholder="${missionDetail.date_start}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3">Date End</label>
                                    <div class="col-md-8">
                                        <input name="date_end" class="form-control col-md-8" type="text" placeholder="${missionDetail.date_end}" disabled>
                                    </div>
                                </div>
                                <div class="tile-footer">
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-3">
                                            ...
                                            <luannm:if test="${missionDetail.date_end != ''}">
                                                <button name="action" value="ToAdminEditMissionDetail" class="btn btn-primary" disabled>Edit</button>
                                            </luannm:if>
                                            <luannm:if test="${missionDetail.date_end == ''}">
                                                <input name="missionId" type="text" value="${missionDetail.mission_id}" hidden>
                                                <button name="action" value="AdminEditMissionDetail" class="btn btn-primary">Save</button>
                                            </luannm:if>
                                        </div>
                                    </div>
                                </div>  
