                        ...
                        <div class="tile-body">
                            ...
                            <form class="form-horizontal" action="FrontController" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input name="phone" class="form-control col-md-8" type="text" placeholder="${missionDetail.myWeapon.weapon_id} - ${missionDetail.myWeapon.weapon_name}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <luannm:if test="${missionDetail.myMission.date_end == ''}">
                                        <div class="row">
                                            <div class="col-md-8 col-md-offset-3">
                                                <button name="action" value="ToChangeWeapon" class="btn btn-primary">Change Weapon to do mission</button>
                                            </div>
                                        </div>
                                    </luannm:if>
                                    <div class="row">
