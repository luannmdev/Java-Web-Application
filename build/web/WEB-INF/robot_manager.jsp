    ...
    <body class="app sidebar-mini rtl">
        ...
        <main class="app-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">Robot Table</h3>
                        <a href="FrontController?action=ToAddRobot" class="btn btn-default btn-sm ">Add New Robot</a>
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <% int count = 0;%>
                                <luannm:set var="listRo" value="${sessionScope.listRobot}" /> 
                                <luannm:forEach var="ro" items="${listRo}">
                                        <tr>
                                            <td><%=count%></td> <% count++;%>
                                            <td>${ro.robot_id}</td>
                                            <td>${ro.robot_name}</td>
                                            ...
                                            <td>${ro.status}</td>
                                            <td>
                                                <a href="FrontController?action=ToAdminViewRobotDetail&robotId=${ro.robot_id}" class="btn btn-default btn-sm">Detail</a>
                                            </td>
                                        </tr>
                                </luannm:forEach>
                            </tbody>
