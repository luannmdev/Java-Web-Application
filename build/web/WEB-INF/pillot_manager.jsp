    ...
    <body class="app sidebar-mini rtl">
        ...
        <main class="app-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">Pillot Table</h3>
                        <a href="FrontController?action=ToAddPillot" class="btn btn-default btn-sm ">Add New Pillot</a>
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <% int count = 0;%>
                                <luannm:set var="listPi" value="${sessionScope.listPillot}" /> 
