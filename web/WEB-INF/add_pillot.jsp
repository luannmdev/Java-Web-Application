    ...
    <body class="app sidebar-mini rtl">
        ...
        <main class="app-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">Add New Pillot</h3>
                        <div class="tile-body">
                            ...
                            <form class="form-horizontal" action="FrontController" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input name="fullName" class="form-control" type="text" placeholder="input pillot's name" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <luannm:set var="listFreeRobot" value="${sessionScope.freeRobotList}" /> 
                                            <label class="control-label col-md-3">Add Robot for Pilot</label>
                                ...
                                <div class="tile-footer">
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-3">
                                            <button name="action" value="AddNewPillot" class="btn btn-primary">Add Pillot</button>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-3">
                                            <a class="btn btn-secondary" href="FrontController?action=ToPillotManager"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
