    ...
    <body class="app sidebar-mini rtl">
        ...
        <main class="app-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">Edit Your Password</h3>
                        <div class="tile-body">
                            ...
                            <form class="form-horizontal" action="FrontController" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input name="old_password" class="form-control col-md-8" type="password" placeholder="input pass" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3">New Password</label>
                                    <div class="col-md-8">
                                        <input name="new_password" class="form-control col-md-8" type="password" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3">Re-New Password</label>
                                    <div class="col-md-8">
                                        <input name="re_new_password" class="form-control col-md-8" type="password" placeholder="">
                                    </div>
                                </div>
                                <div class="tile-footer">
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-3">
                                            <button name="action" value="EditPassword" class="btn btn-primary">Save Changed</button>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-3">
