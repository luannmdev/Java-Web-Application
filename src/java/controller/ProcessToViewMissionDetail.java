 ...
 */
public class ProcessToViewMissionDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("user") != null) {
            ...
            robot.setListWeapon(UserDAO.getWeaponList(robot.getRobot_id()));
            String weaponId = UserDAO.getMissionWeaponID(profile.getUserName(), missionId);
            Weapon thatTimeWeapon = null;
            if (weaponId != null) {
                thatTimeWeapon = UserDAO.getMissionWeapon(weaponId);
            }
            MissionDetail missionDetail = new MissionDetail(mission, robot, thatTimeWeapon);
            session.setAttribute("userMissionDetail", missionDetail);
            RequestDispatcher dis = request.getRequestDispatcher("WEB-INF/my_mission_detail.jsp");
