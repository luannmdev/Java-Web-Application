 ...
 */
public class ProcessSaveProfile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dis = request.getRequestDispatcher("WEB-INF/edit_profile.jsp");
        ...
        if (!Validate.checkString(fullName)) {
            ...
            Profile profile = new Profile(username, fullName, phone, sex, birthday, "", "", "", "", true, true);
            if (UserDAO.updateUser(profile)) {
                request.setAttribute("error", "Updated!");
                oldProfile.setFullName(fullName);
                oldProfile.setPhone(phone);
                oldProfile.setBirthday(birthday);
                oldProfile.setSex(sex);
                session.setAttribute("profile", oldProfile);
            } else {
