 ...
 */
public class ProcessAdminEditMissionDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dis = request.getRequestDispatcher("WEB-INF/admin_edit_mission.jsp");
        ...
        if (!Validate.checkString(mission_name)) {
            ...
            if (UserDAO.updateMissionDetail(missionId, mission_name, description)) {
